...
namespace WowPacketParser.Enums.Version.V2_4_3_8606
{
    public static class Opcodes_2_4_3
    {
        ...
        {
            {Opcode.CMSG_BOOTME, 0x001},
            {Opcode.CMSG_DBLOOKUP, 0x002},
            {Opcode.CMSG_QUERY_OBJECT_POSITION, 0x004},
            {Opcode.CMSG_QUERY_OBJECT_ROTATION, 0x006},
            {Opcode.CMSG_WORLD_TELEPORT, 0x008},
            {Opcode.CMSG_TELEPORT_TO_UNIT, 0x009},
            {Opcode.CMSG_ZONE_MAP, 0x00A},
            {Opcode.CMSG_DEBUG_CHANGECELLZONE, 0x00C},
			//{Opcode.CMSG_EMBLAZON_TABARD_OBSOLETE, 0x00D},
			//{Opcode.CMSG_UNEMBLAZON_TABARD_OBSOLETE, 0x00E},
			{Opcode.CMSG_RECHARGE, 0x00F},
            {Opcode.CMSG_LEARN_SPELL, 0x010},
            {Opcode.CMSG_CREATEMONSTER, 0x011},
            {Opcode.CMSG_DESTROYMONSTER, 0x012},
            {Opcode.CMSG_CREATEITEM, 0x013},
            {Opcode.CMSG_CREATEGAMEOBJECT, 0x014},
            {Opcode.CMSG_MAKEMONSTERATTACKGUID, 0x016},
            {Opcode.CMSG_BOT_DETECTED2, 0x017},
            {Opcode.CMSG_FORCEACTION, 0x018},
            {Opcode.CMSG_FORCEACTIONONOTHER, 0x019},
            {Opcode.CMSG_FORCEACTIONSHOW, 0x01A},
            {Opcode.CMSG_PETGODMODE, 0x01C},
            {Opcode.CMSG_WEATHER_SPEED_CHEAT, 0x01F},
            {Opcode.CMSG_UNDRESSPLAYER, 0x020},
            {Opcode.CMSG_BEASTMASTER, 0x021},
            {Opcode.CMSG_GODMODE, 0x022},
            {Opcode.CMSG_CHEAT_SETMONEY, 0x024},
            {Opcode.CMSG_LEVEL_CHEAT, 0x025},
            {Opcode.CMSG_PET_LEVEL_CHEAT, 0x026},
            {Opcode.CMSG_SET_WORLDSTATE, 0x027},
            {Opcode.CMSG_COOLDOWN_CHEAT, 0x028},
            {Opcode.CMSG_USE_SKILL_CHEAT, 0x029},
            {Opcode.CMSG_FLAG_QUEST, 0x02A},
            {Opcode.CMSG_FLAG_QUEST_FINISH, 0x02B},
            {Opcode.CMSG_CLEAR_QUEST, 0x02C},
            {Opcode.CMSG_SEND_EVENT, 0x02D},
            {Opcode.CMSG_DEBUG_AISTATE, 0x02E},
            {Opcode.CMSG_DISABLE_PVP_CHEAT, 0x030},
            {Opcode.CMSG_ADVANCE_SPAWN_TIME, 0x031},
			//{Opcode.CMSG_PVP_PORT_OBSOLETE, 0x032},
			{Opcode.CMSG_AUTH_SRP6_BEGIN, 0x033},
            {Opcode.CMSG_AUTH_SRP6_PROOF, 0x034},
            {Opcode.CMSG_AUTH_SRP6_RECODE, 0x035},
            {Opcode.CMSG_CREATE_CHARACTER, 0x036},
            {Opcode.CMSG_ENUM_CHARACTERS, 0x037},
            {Opcode.CMSG_CHAR_DELETE, 0x038},
            {Opcode.CMSG_PLAYER_LOGIN, 0x03D},
            {Opcode.CMSG_GAMETIME_SET, 0x044},
            {Opcode.CMSG_GAMESPEED_SET, 0x046},
            {Opcode.CMSG_SERVERTIME, 0x048},
            {Opcode.CMSG_PLAYER_LOGOUT, 0x04A},
            {Opcode.CMSG_LOGOUT_REQUEST, 0x04B},
            {Opcode.CMSG_LOGOUT_CANCEL, 0x04E},
            {Opcode.CMSG_NAME_QUERY, 0x050},
            {Opcode.CMSG_QUERY_PET_NAME, 0x052},
            {Opcode.CMSG_QUERY_GUILD_INFO, 0x054},
            {Opcode.CMSG_ITEM_QUERY_SINGLE, 0x056},
            {Opcode.CMSG_ITEM_QUERY_MULTIPLE, 0x057},
            {Opcode.CMSG_QUERY_PAGE_TEXT, 0x05A},
            {Opcode.CMSG_QUERY_QUEST_INFO, 0x05C},
            {Opcode.CMSG_QUERY_GAME_OBJECT, 0x05E},
            {Opcode.CMSG_QUERY_CREATURE, 0x060},
            {Opcode.CMSG_WHO, 0x062},
            {Opcode.CMSG_WHO_IS, 0x064},
            {Opcode.CMSG_CONTACT_LIST, 0x066},
            {Opcode.CMSG_ADD_FRIEND, 0x069},
            {Opcode.CMSG_DEL_FRIEND, 0x06A},
            {Opcode.CMSG_SET_CONTACT_NOTES, 0x06B},
            {Opcode.CMSG_ADD_IGNORE, 0x06C},
            {Opcode.CMSG_DEL_IGNORE, 0x06D},
            {Opcode.CMSG_GROUP_INVITE, 0x06E},
            {Opcode.CMSG_GROUP_CANCEL, 0x070},
            {Opcode.CMSG_GROUP_ACCEPT, 0x072},
            {Opcode.CMSG_GROUP_DECLINE, 0x073},
            {Opcode.CMSG_GROUP_UNINVITE, 0x075},
            {Opcode.CMSG_GROUP_UNINVITE_GUID, 0x076},
            {Opcode.CMSG_GROUP_SET_LEADER, 0x078},
            {Opcode.CMSG_SET_LOOT_METHOD, 0x07A},
            {Opcode.CMSG_GROUP_DISBAND, 0x07B},
            {Opcode.CMSG_GUILD_CREATE, 0x081},
            {Opcode.CMSG_GUILD_INVITE, 0x082},
            {Opcode.CMSG_GUILD_ACCEPT, 0x084},
            {Opcode.CMSG_GUILD_DECLINE_INVITATION, 0x085},
            {Opcode.CMSG_GUILD_INFO, 0x087},
            {Opcode.CMSG_GUILD_GET_ROSTER, 0x089},
            {Opcode.CMSG_GUILD_PROMOTE_MEMBER, 0x08B},
            {Opcode.CMSG_GUILD_DEMOTE_MEMBER, 0x08C},
            {Opcode.CMSG_GUILD_LEAVE, 0x08D},
            {Opcode.CMSG_GUILD_OFFICER_REMOVE_MEMBER, 0x08E},
            {Opcode.CMSG_GUILD_DISBAND, 0x08F},
            {Opcode.CMSG_GUILD_LEADER, 0x090},
            {Opcode.CMSG_GUILD_MOTD, 0x091},
            {Opcode.CMSG_MESSAGECHAT, 0x095},
            {Opcode.CMSG_CHAT_JOIN_CHANNEL, 0x097},
            {Opcode.CMSG_CHAT_LEAVE_CHANNEL, 0x098},
            {Opcode.CMSG_CHAT_CHANNEL_LIST, 0x09A},
            {Opcode.CMSG_CHAT_CHANNEL_PASSWORD, 0x09C},
            {Opcode.CMSG_CHAT_CHANNEL_SET_OWNER, 0x09D},
            {Opcode.CMSG_CHAT_CHANNEL_OWNER, 0x09E},
            {Opcode.CMSG_CHAT_CHANNEL_MODERATOR, 0x09F},
            {Opcode.CMSG_CHAT_CHANNEL_UNMODERATOR, 0x0A0},
            {Opcode.CMSG_CHAT_CHANNEL_MUTE, 0x0A1},
            {Opcode.CMSG_CHAT_CHANNEL_UNMUTE, 0x0A2},
            {Opcode.CMSG_CHAT_CHANNEL_INVITE, 0x0A3},
            {Opcode.CMSG_CHAT_CHANNEL_KICK, 0x0A4},
            {Opcode.CMSG_CHAT_CHANNEL_BAN, 0x0A5},
            {Opcode.CMSG_CHAT_CHANNEL_UNBAN, 0x0A6},
            {Opcode.CMSG_CHAT_CHANNEL_ANNOUNCEMENTS, 0x0A7},
            {Opcode.CMSG_CHAT_CHANNEL_MODERATE, 0x0A8},
            {Opcode.CMSG_USE_ITEM, 0x0AB},
            {Opcode.CMSG_OPEN_ITEM, 0x0AC},
            {Opcode.CMSG_READ_ITEM, 0x0AD},
            {Opcode.CMSG_GAME_OBJ_USE, 0x0B1},
            {Opcode.CMSG_DESTROY_ITEMS, 0x0B2},
            {Opcode.CMSG_AREA_TRIGGER, 0x0B4},
            {Opcode.CMSG_MOVE_SET_RAW_POSITION, 0x0E1},
            {Opcode.CMSG_FORCE_RUN_SPEED_CHANGE_ACK, 0x0E3},
            {Opcode.CMSG_FORCE_RUN_BACK_SPEED_CHANGE_ACK, 0x0E5},
            {Opcode.CMSG_FORCE_SWIM_SPEED_CHANGE_ACK, 0x0E7},
            {Opcode.CMSG_FORCE_MOVE_ROOT_ACK, 0x0E9},
            {Opcode.CMSG_FORCE_MOVE_UNROOT_ACK, 0x0EB},
            {Opcode.CMSG_MOVE_KNOCK_BACK_ACK, 0x0F0},
            {Opcode.CMSG_MOVE_HOVER_ACK, 0x0F6},
            {Opcode.CMSG_TRIGGER_CINEMATIC_CHEAT, 0x0F8},
            {Opcode.CMSG_OPENING_CINEMATIC, 0x0F9},
            {Opcode.CMSG_NEXT_CINEMATIC_CAMERA, 0x0FB},
            {Opcode.CMSG_COMPLETE_CINEMATIC, 0x0FC},
            {Opcode.CMSG_TUTORIAL_FLAG, 0x0FE},
            {Opcode.CMSG_TUTORIAL_CLEAR, 0x0FF},
			...
			//{Opcode.CMSG_UNUSED, 0x13F},
			//{Opcode.CMSG_UNUSED2, 0x140},
			{Opcode.CMSG_ATTACK_SWING, 0x141},
            {Opcode.CMSG_ATTACK_STOP, 0x142},
			//{Opcode.CMSG_SHEATHE_OBSOLETE, 0x152},
			...
			//{Opcode.CMSG_PLAYER_MACRO_OBSOLETE, 0x1E3},
			...
			//{Opcode.CMSG_RWHOIS_OBSOLETE, 0x1FD},
			//{Opcode.CMSG_SET_LOOKING_FOR_GROUP, 0x200},
            ...
            //{Opcode.CMSG_MEETINGSTONE_JOIN, 0x292},
            {Opcode.CMSG_MEETINGSTONE_CHEAT, 0x294},
            {Opcode.CMSG_MEETINGSTONE_INFO, 0x296},
            ...
            {Opcode.CMSG_MOVE_FLIGHT_ACK, 0x340},
			...
			//{Opcode.CMSG_LFG_SET_AUTOJOIN, 0x35C},
			//{Opcode.CMSG_LFG_CLEAR_AUTOJOIN, 0x35D},
			//{Opcode.CMSG_LFM_SET_AUTOFILL, 0x35E},
			//{Opcode.CMSG_LFM_CLEAR_AUTOFILL, 0x35F},
			//{Opcode.CMSG_ACCEPT_LFG_MATCH, 0x360},
			//{Opcode.CMSG_DECLINE_LFG_MATCH, 0x361},
			//{Opcode.CMSG_CANCEL_PENDING_LFG, 0x362},
			//{Opcode.CMSG_CLEAR_LOOKING_FOR_GROUP, 0x363},
			//{Opcode.CMSG_CLEAR_LOOKING_FOR_MORE, 0x364},
            ...
            //{Opcode.CMSG_GROUPACTION_THROTTLED, 0x410},
        ...
        {
            {Opcode.SMSG_DBLOOKUP, 0x003},
            {Opcode.SMSG_QUERY_OBJ_POSITION, 0x005},
            {Opcode.SMSG_QUERY_OBJ_ROTATION, 0x007},
            {Opcode.SMSG_ZONE_MAP, 0x00B},
            {Opcode.SMSG_CHECK_FOR_BOTS, 0x015},
            {Opcode.SMSG_FORCEACTIONSHOW, 0x01B},
            {Opcode.SMSG_PETGODMODE, 0x01D},
            {Opcode.SMSG_REFER_A_FRIEND_EXPIRED, 0x01E},
            {Opcode.SMSG_GOD_MODE, 0x023},
            {Opcode.SMSG_DEBUG_AISTATE, 0x02F},
            {Opcode.SMSG_AUTH_SRP6_RESPONSE, 0x039},
            {Opcode.SMSG_CREATE_CHAR, 0x03A},
            {Opcode.SMSG_ENUM_CHARACTERS_RESULT, 0x03B},
            {Opcode.SMSG_DELETE_CHAR, 0x03C},
            {Opcode.SMSG_NEW_WORLD, 0x03E},
            {Opcode.SMSG_TRANSFER_PENDING, 0x03F},
            {Opcode.SMSG_TRANSFER_ABORTED, 0x040},
            {Opcode.SMSG_CHARACTER_LOGIN_FAILED, 0x041},
            {Opcode.SMSG_LOGIN_SET_TIME_SPEED, 0x042},
            {Opcode.SMSG_GAME_TIME_UPDATE, 0x043},
            {Opcode.SMSG_GAME_TIME_SET, 0x045},
            {Opcode.SMSG_GAME_SPEED_SET, 0x047},
            {Opcode.SMSG_SERVERTIME, 0x049},
            {Opcode.SMSG_LOGOUT_RESPONSE, 0x04C},
            {Opcode.SMSG_LOGOUT_COMPLETE, 0x04D},
            {Opcode.SMSG_LOGOUT_CANCEL_ACK, 0x04F},
            {Opcode.SMSG_QUERY_PLAYER_NAME_RESPONSE, 0x051},
            {Opcode.SMSG_QUERY_PET_NAME_RESPONSE, 0x053},
            {Opcode.SMSG_QUERY_GUILD_INFO_RESPONSE, 0x055},
            {Opcode.SMSG_ITEM_QUERY_SINGLE_RESPONSE, 0x058},
            {Opcode.SMSG_ITEM_QUERY_MULTIPLE_RESPONSE, 0x059},
            {Opcode.SMSG_QUERY_PAGE_TEXT_RESPONSE, 0x05B},
            {Opcode.SMSG_QUERY_QUEST_INFO_RESPONSE, 0x05D},
            {Opcode.SMSG_QUERY_GAME_OBJECT_RESPONSE, 0x05F},
            {Opcode.SMSG_QUERY_CREATURE_RESPONSE, 0x061},
            {Opcode.SMSG_WHO, 0x063},
            {Opcode.SMSG_WHO_IS, 0x065},
            {Opcode.SMSG_CONTACT_LIST, 0x067},
            {Opcode.SMSG_FRIEND_STATUS, 0x068},
            {Opcode.SMSG_GROUP_INVITE, 0x06F},
            {Opcode.SMSG_GROUP_CANCEL, 0x071},
            {Opcode.SMSG_GROUP_DECLINE, 0x074},
            {Opcode.SMSG_GROUP_UNINVITE, 0x077},
            {Opcode.SMSG_GROUP_SET_LEADER, 0x079},
            {Opcode.SMSG_GROUP_DESTROYED, 0x07C},
            {Opcode.SMSG_GROUP_LIST, 0x07D},
            {Opcode.SMSG_PARTY_MEMBER_STATS, 0x07E},
            {Opcode.SMSG_PARTY_COMMAND_RESULT, 0x07F},
            {Opcode.SMSG_GUILD_INVITE, 0x083},
            {Opcode.SMSG_GUILD_DECLINE, 0x086},
            {Opcode.SMSG_GUILD_INFO, 0x088},
            {Opcode.SMSG_GUILD_ROSTER, 0x08A},
            {Opcode.SMSG_GUILD_EVENT, 0x092},
            {Opcode.SMSG_GUILD_COMMAND_RESULT, 0x093},
            {Opcode.SMSG_CHAT, 0x096},
            {Opcode.SMSG_CHANNEL_NOTIFY, 0x099},
            {Opcode.SMSG_CHANNEL_LIST, 0x09B},
            {Opcode.SMSG_UPDATE_OBJECT, 0x0A9},
            {Opcode.SMSG_DESTROY_OBJECT, 0x0AA},
            {Opcode.SMSG_READ_ITEM_RESULT_OK, 0x0AE},
            {Opcode.SMSG_READ_ITEM_RESULT_FAILED, 0x0AF},
            {Opcode.SMSG_ITEM_COOLDOWN, 0x0B0},
            {Opcode.SMSG_GAME_OBJECT_CUSTOM_ANIM, 0x0B3},
            {Opcode.SMSG_ON_MONSTER_MOVE, 0x0DD},
            {Opcode.SMSG_MOVE_SET_WATER_WALK, 0x0DE},
            {Opcode.SMSG_MOVE_SET_LAND_WALK, 0x0DF},
            {Opcode.SMSG_FORCE_RUN_SPEED_CHANGE, 0x0E2},
            {Opcode.SMSG_FORCE_RUN_BACK_SPEED_CHANGE, 0x0E4},
            {Opcode.SMSG_FORCE_SWIM_SPEED_CHANGE, 0x0E6},
            {Opcode.SMSG_FORCE_MOVE_ROOT, 0x0E8},
            {Opcode.SMSG_FORCE_MOVE_UNROOT, 0x0EA},
            {Opcode.SMSG_MOVE_KNOCK_BACK, 0x0EF},
            {Opcode.SMSG_MOVE_SET_FEATHER_FALL, 0x0F2},
            {Opcode.SMSG_MOVE_SET_NORMAL_FALL, 0x0F3},
            {Opcode.SMSG_MOVE_SET_HOVERING, 0x0F4},
            {Opcode.SMSG_MOVE_UNSET_HOVERING, 0x0F5},
            {Opcode.SMSG_TRIGGER_CINEMATIC, 0x0FA},
            {Opcode.SMSG_TUTORIAL_FLAGS, 0x0FD},
            ...
            //{Opcode.SMSG_ATTACKSWING_NOTSTANDING, 0x147},
            {Opcode.SMSG_ATTACKSWING_DEADTARGET, 0x148},
            {Opcode.SMSG_ATTACKSWING_CANT_ATTACK, 0x149},
            {Opcode.SMSG_ATTACKER_STATE_UPDATE, 0x14A},
			//{Opcode.SMSG_VICTIMSTATEUPDATE_OBSOLETE, 0x14B},
			//{Opcode.SMSG_DAMAGE_DONE_OBSOLETE, 0x14C},
			//{Opcode.SMSG_DAMAGE_TAKEN_OBSOLETE, 0x14D},
			{Opcode.SMSG_CANCEL_COMBAT, 0x14E},
			//{Opcode.SMSG_PLAYER_COMBAT_XP_GAIN_OBSOLETE, 0x14F},
			...
			//{Opcode.SMSG_PUREMOUNT_CANCELLED_OBSOLETE, 0x170},
			...
			//{Opcode.SMSG_PLAYER_MACRO_OBSOLETE, 0x1E4},
			...
			//{Opcode.SMSG_POWERGAINLOG_OBSOLETE, 0x20E},
			{Opcode.SMSG_GM_TICKET_GET_TICKET, 0x212},
			//{Opcode.SMSG_GAMEOBJECT_SPAWN_ANIM_OBSOLETE, 0x214},
            ...
            //{Opcode.SMSG_SET_REST_START, 0x21E},
			...
			//{Opcode.SMSG_BATTLEFIELD_WIN_OBSOLETE, 0x23F},
			//{Opcode.SMSG_BATTLEFIELD_LOSE_OBSOLETE, 0x240},
            ...
            //{Opcode.SMSG_MEETINGSTONE_LEAVE, 0x293},
            {Opcode.SMSG_MEETINGSTONE_SETQUEUE, 0x295},
            {Opcode.SMSG_MEETINGSTONE_COMPLETE, 0x297},
            {Opcode.SMSG_MEETINGSTONE_IN_PROGRESS, 0x298},
            {Opcode.SMSG_MEETINGSTONE_MEMBER_ADDED, 0x299},
            ...
            //{Opcode.SMSG_MEETINGSTONE_JOINFAILED, 0x2BB},
            ...
            {Opcode.SMSG_MOVE_SET_FLIGHT, 0x33E},
            {Opcode.SMSG_MOVE_UNSET_FLIGHT, 0x33F},
			...
			//{Opcode.SMSG_LFG_TIMEDOUT, 0x367},
			//{Opcode.SMSG_LFG_OTHER_TIMEDOUT, 0x368},
			//{Opcode.SMSG_LFG_AUTOJOIN_FAILED, 0x369},
			//{Opcode.SMSG_LFG_AUTOJOIN_FAILED_NO_PLAYER, 0x36A},
			//{Opcode.SMSG_LFG_LEADER_IS_LFM, 0x36B},
			//{Opcode.SMSG_LFG_UPDATE, 0x36C},
			//{Opcode.SMSG_LFG_UPDATE_LFM, 0x36D},
			//{Opcode.SMSG_LFG_UPDATE_LFG, 0x36E},
			//{Opcode.SMSG_LFG_UPDATE_QUEUED, 0x36F},
			//{Opcode.SMSG_LFG_PENDING_INVITE, 0x370},
			//{Opcode.SMSG_LFG_PENDING_MATCH, 0x371},
			//{Opcode.SMSG_LFG_PENDING_MATCH_DONE, 0x372},
        ...
        {
            //{Opcode.MSG_NULL_ACTION, 0x000},
            {Opcode.UMSG_UPDATE_GROUP_MEMBERS, 0x080},
            {Opcode.UMSG_UPDATE_GUILD, 0x094},
            {Opcode.MSG_MOVE_START_FORWARD, 0x0B5},
            {Opcode.MSG_MOVE_START_BACKWARD, 0x0B6},
            {Opcode.MSG_MOVE_STOP, 0x0B7},
            {Opcode.MSG_MOVE_START_STRAFE_LEFT, 0x0B8},
            {Opcode.MSG_MOVE_START_STRAFE_RIGHT, 0x0B9},
            {Opcode.MSG_MOVE_STOP_STRAFE, 0x0BA},
            {Opcode.MSG_MOVE_JUMP, 0x0BB},
            {Opcode.MSG_MOVE_START_TURN_LEFT, 0x0BC},
            {Opcode.MSG_MOVE_START_TURN_RIGHT, 0x0BD},
            {Opcode.MSG_MOVE_STOP_TURN, 0x0BE},
            {Opcode.MSG_MOVE_START_PITCH_UP, 0x0BF},
            {Opcode.MSG_MOVE_START_PITCH_DOWN, 0x0C0},
            {Opcode.MSG_MOVE_STOP_PITCH, 0x0C1},
            {Opcode.MSG_MOVE_SET_RUN_MODE, 0x0C2},
            {Opcode.MSG_MOVE_SET_WALK_MODE, 0x0C3},
            {Opcode.MSG_MOVE_TOGGLE_LOGGING, 0x0C4},
            {Opcode.MSG_MOVE_TELEPORT, 0x0C5},
            {Opcode.MSG_MOVE_TELEPORT_CHEAT, 0x0C6},
            {Opcode.MSG_MOVE_TELEPORT_ACK, 0x0C7},
            {Opcode.MSG_MOVE_TOGGLE_FALL_LOGGING, 0x0C8},
            {Opcode.MSG_MOVE_FALL_LAND, 0x0C9},
            {Opcode.MSG_MOVE_START_SWIM, 0x0CA},
            {Opcode.MSG_MOVE_STOP_SWIM, 0x0CB},
            {Opcode.MSG_MOVE_SET_RUN_SPEED_CHEAT, 0x0CC},
            {Opcode.MSG_MOVE_SET_RUN_SPEED, 0x0CD},
            {Opcode.MSG_MOVE_SET_RUN_BACK_SPEED_CHEAT, 0x0CE},
            {Opcode.MSG_MOVE_SET_RUN_BACK_SPEED, 0x0CF},
            {Opcode.MSG_MOVE_SET_WALK_SPEED_CHEAT, 0x0D0},
            {Opcode.MSG_MOVE_SET_WALK_SPEED, 0x0D1},
            {Opcode.MSG_MOVE_SET_SWIM_SPEED_CHEAT, 0x0D2},
            {Opcode.MSG_MOVE_SET_SWIM_SPEED, 0x0D3},
            {Opcode.MSG_MOVE_SET_SWIM_BACK_SPEED_CHEAT, 0x0D4},
            {Opcode.MSG_MOVE_SET_SWIM_BACK_SPEED, 0x0D5},
            {Opcode.MSG_MOVE_SET_ALL_SPEED_CHEAT, 0x0D6},
            {Opcode.MSG_MOVE_SET_TURN_RATE_CHEAT, 0x0D7},
            {Opcode.MSG_MOVE_SET_TURN_RATE, 0x0D8},
            {Opcode.MSG_MOVE_TOGGLE_COLLISION_CHEAT, 0x0D9},
            {Opcode.MSG_MOVE_SET_FACING, 0x0DA},
            {Opcode.MSG_MOVE_SET_PITCH, 0x0DB},
            {Opcode.MSG_MOVE_WORLDPORT_ACK, 0x0DC},
            {Opcode.MSG_MOVE_SET_RAW_POSITION_ACK, 0x0E0},
            {Opcode.MSG_MOVE_ROOT, 0x0EC},
            {Opcode.MSG_MOVE_UNROOT, 0x0ED},
            {Opcode.MSG_MOVE_HEARTBEAT, 0x0EE},
            {Opcode.MSG_MOVE_KNOCK_BACK, 0x0F1},
            {Opcode.MSG_MOVE_HOVER, 0x0F7},
            ...
            //{Opcode.MSG_LOOKING_FOR_GROUP, 0x1FF},
            ...
            {Opcode.MSG_MOVE_TOGGLE_GRAVITY_CHEAT, 0x2AD},
            ...
            {Opcode.UMSG_UPDATE_ARENA_TEAM_OBSOLETE, 0x34A},
